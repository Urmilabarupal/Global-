...
export const INITIAL_SETTINGS: InstituteSettings = {
  ...
  testSeriesDays: "Every Monday and Wednesday",
...
export const INITIAL_COURSES: Course[] = [
  {
    ...
    preparationModes: [
      "4-5 hours of daily classes led by subject experts",
      "OMR sheet-based test series every Monday and Wednesday",
      "100% syllabus-aligned printed and handwritten notes",
      "Detailed solutions for previous years' question papers (PYQs)",
      "Dedicated doubt counter and guidance for students who need extra support",
      "3 days of completely free demo classes"
    ],
    syllabusHighlights: [
      "Rajasthan History, Art, Culture, Literature, Traditions & Heritage",
      "Indian & Rajasthan Geography, Climate, Rivers & Vegetation",
      "Nature of the Indian Constitution, Fundamental Rights, Directive Principles & Rajasthan Administration",
      "General Science: Physical & Chemical Changes, Metals & Non-metals, Human Body & Genetics",
      "Logical Analysis & Analytical Ability (Reasoning Shortcuts)",
      "Number System, Percentages, Profit & Loss, Simple & Compound Interest, Time & Distance",
      "Sandhi, Samasa, Prefixes, Suffixes, Synonyms, Antonyms, Word & Sentence Correction",
